        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h6>@isset($stock) Edit @else Add @endisset Stock </h6>
                ...
                <div class="card-body">
                    ...
                    @endisset
                        ...
                        <div class="form-group d-flex">
                            ...
                            <div class="col-sm-6">
                                @isset($stock)
                                    <input type="text" class="form-control ui-autocomplete-input @error('name') is-invalid @enderror"
                                    id="exampleInputName1" value="{{ Old('name') ?? $stock['name']  }}" name="name" autocomplete="off"
                        ...
                        <div class="form-group d-flex">
                            ...
                            <div class="col-sm-6">
                                @isset($stock)
                                    ...
                                    id="exampleInputUserSymbol1" value="{{ Old('symbol') ?? $stock['symbol'] }}" name="symbol" autocomplete="off"
                                    placeholder="Enter Symbol">
                                @else
                                    <input type="text"
                                    class="form-control ui-autocomplete-input @error('symbol') is-invalid @enderror"
                                    id="exampleInputUserSymbol1" value="{{ Old('symbol') }}" name="symbol" autocomplete="off"
                                    placeholder="Enter Symbol">
                                @endisset
                        ...
                        <div class="form-group d-flex">
                            ...
                            <div class="col-sm-6">
                                @isset($stock)
                                    ...
                                    @error('market') is-invalid @enderror"
                                    id="exampleInputMarket1" value="{{ Old('market') ?? $stock['market'] }}" name="market"
                                    autocomplete="off" placeholder="Enter Market">
                                @else
                                    <input type="text" class="form-control ui-autocomplete-input 
                                    @error('market') is-invalid @enderror"
                                    id="exampleInputMarket1" value="{{ Old('market') }}" name="market"
                                    autocomplete="off" placeholder="Enter Market">
                                @endisset
                        ...
                        <div class="form-group d-flex">
                            ...
                            <div class="col-sm-6">
                                <select name="status">
                                    ...
                                    <option value="0" {{$stock->status == '0' ? 'selected' : ''}}>Inactive</option>
                                </select>
                            </div>
                        </div>
                        @endisset
